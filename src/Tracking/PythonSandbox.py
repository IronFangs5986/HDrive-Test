...
class PythonSandbox:
    ...
    # ###################################################################################################
        ...
        self.__hsv_threshold_value = [250.0, 255.0]
...
##################################################################################################
        ...
        output = "X: "+str(tx)+", Y: "+str(ty)+", Area: "+str(ta)
        cv2.putText(outimg, output, (3, height - 6), cv2.FONT_HERSHEY_SIMPLEX, 0.4, (255,255,255), 1, cv2.LINE_AA)
